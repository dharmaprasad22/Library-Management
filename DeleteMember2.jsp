            ...
            <table width="100%" border="0" >
                ...
                <tbody>
                    <tr>
                        ...
                        <td width="75%" valign="top" align="center"><font size="+2"><b>Delete Member<br><br></b></font>
                                    <%
      /*      int k = JOptionPane.showConfirmDialog(null, "Are Sure ?", "Delete User", JOptionPane.YES_NO_OPTION);
            if (k != 0) {
          ...
          Connection  con = DriverManager.getConnection("jdbc:mysql://localhost:3306/library","root","root");
                PreparedStatement ps = con.prepareStatement("delete from member where MemID='" + memID + "';");
                int i = ps.executeUpdate();
                ps = con.prepareStatement("delete from login where username='" + memID + "';");
                i = ps.executeUpdate();
                                    %>
                            <br><h1>Record is Successfully Deleted.</h1><br>
                            <%
           // }
                            %>
