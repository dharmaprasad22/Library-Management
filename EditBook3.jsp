    ...
    <div class="content">
        ...
        <div id="main">
            ...
            <table width="100%" border="0" >
                ...
                <tbody>
                    <tr>
                        ...
                        <td width="75%" valign="top" align="center"><font size="+2"><b>Edit Book<br><br></b></font>
                                    <%
          ...
          Connection  con = DriverManager.getConnection("jdbc:mysql://localhost:3306/library","root","root");
                PreparedStatement ps = con.prepareStatement("update book set AccountNo='" + accountno + "',Title='" + title + "',Author='" + author + "',Price='" + price + "',Edition='" + edition + "',Publisher='" + publisher + "',YearOfPublication='" + yop + "' where CallNo='" + callno + "'");
                int i = ps.executeUpdate();
                             %>
                            <br><h1>Record was Successfully Updated.</h1><br>
                            <%
            }
                            %>
